...
namespace AmpProcessing {
	namespace Effects {
		class Reverb : public IEffectProcessor {
		public:
			Reverb() : IEffectProcessor("Reverb"), m_ProcessBuffer(128), m_SampleConvolver(std::make_unique<DSP::FFTSampleConvolver>()),
			...
			{
				AudioFile<float> reverbFile;
				reverbFile.load("C:\\Repos\\resources\\greathall.wav");

				m_SampleConvolver->Init(128 * 2, reverbFile.samples[0]);
			};
			~Reverb() {};
