...
namespace AmpProcessing {
	namespace Converters {
		...
		void Int32LsbAudioConverter::ConvertToFloat(void* from, std::vector<float>& to, unsigned int fromAmount)
		{
		...
		void Int32LsbAudioConverter::ConvertFromFloat(std::vector<float>& from, void* to)
		{
			auto size = from.size();
